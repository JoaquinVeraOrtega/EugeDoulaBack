...
class Tejedora(Service):
    ...
    list1 = ArrayField(models.CharField(max_length=550))
    list2_title = models.TextField()
    list2 = ArrayField(models.CharField(max_length=550))
...
class GestarParirAlumbrar(Service):
    ...
    list3 = ArrayField(models.CharField(max_length=550))
    list4_title = models.TextField()
    list4 = ArrayField(models.CharField(max_length=550))
    list5_title = models.TextField()
    list5 = ArrayField(models.CharField(max_length=550))
...
class Cartografia(Service):
    ...
    list = ArrayField(models.CharField(max_length=550))
